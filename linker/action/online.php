 ...
 */
/*
http://localhost:8880/online/v1?
uuid=13693057265&
opid=CUCC&
appId=360&
deviceType=HUAWEI&
osVersion=Android4.4&
timeStamp=20141231150001010&
signatureVersion=v1&
signature=c50d5599d325989ed401fb2943e2f5adeb2baa227f5bdbcd8cefd94157f98067
*/
$sigInterfaceName = "/online_signature/v1?";
$activeInterfaceName = "/online/v1?";
...
if (curl_getinfo($sig, CURLINFO_HTTP_CODE) == '200') {
    ...
    echo "上线手机号：" . $uuid . "<br>APP： " . $appId . "<br>" . "<br>激活结果：";
